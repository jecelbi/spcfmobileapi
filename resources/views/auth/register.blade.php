                    ...
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input id="student_number" type="number" class="form-control @error('student_number') is-invalid @enderror" name="student_number" value="{{ old('student_number') }}" required autocomplete="student_number">
